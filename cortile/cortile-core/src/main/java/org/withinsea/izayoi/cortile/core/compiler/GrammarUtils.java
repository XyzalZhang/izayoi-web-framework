...
public class GrammarUtils {
    ...
    public static class Accept {
        ...
        public static boolean byName(Attribute attr, String name) {
            return attr.getName().equals(name);
        }

        public static boolean byNamePrefix(Attribute attr, String name) {
            return attr.getName().startsWith(name);
        }

        public static boolean byTextPrefix(Comment comment, String prefix) {
            return comment.getText().startsWith(prefix);
        }
    }
