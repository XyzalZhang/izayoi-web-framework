 ...
 * Time: 7:19:08
 */
public class DomReader extends SAXReader {

    public DomReader() throws SAXException {
        super(new DomDocumentFactory());
    }
        ...
        return new org.apache.xerces.parsers.SAXParser(new XML11Configuration() {
            ...
            protected void addComponent(XMLComponent component) {
                if (component.getClass() == XMLDocumentScannerImpl.class) {
                    fNonNSScanner = new DomDocumentScanner();
                        ...
                        public void setScannerVersion(short version) {
                            if (version == Constants.XML_VERSION_1_0) {
                                if (fXML10EntityScanner == null) {
                                    fXML10EntityScanner = new DomDocumentScanner.SpaceBufferEntityScanner();
                                }
...
//            html = hold(html, "\r", "Ｒ", "_");
            ...
            html = html.substring(0, start) + "<" + RosaceConstants.TAGNAME_ANONYMOUS + ">" + html.substring(start) + "</" + RosaceConstants.TAGNAME_ANONYMOUS + ">";
            return html;
        }
            ...
            for (Node node : (List<Node>) branch.content()) {
                for (Map.Entry<String, String> e : holders.entrySet()) {
                    if (node instanceof CharacterData) {
                        ...
                        for (DomSurroundableAttr attr : (List<DomSurroundableAttr>) ((Element) node).attributes()) {
