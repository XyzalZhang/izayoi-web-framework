...
package org.withinsea.izayoi.rosace.core.impl.template.dom.grammar;

import org.withinsea.izayoi.common.util.LazyLinkedHashMap;
import org.withinsea.izayoi.common.util.LazyTreeMap;
...
public class GrammarUtils {
    ...
    public static <T extends Grammar> Set<T> filte(Collection<Grammar> grammars, Class<T> grammarClass) {
    ...
    public static <T extends Grammar> List<T> sort(Collection<Grammar> grammars, Class<T> grammarClass, final String sortMethod) {
    ...
    public static Map<Integer, Map<String, List<AttrGrammar>>> group(Map<String, ? extends Collection<Grammar>> grammarMap) {
