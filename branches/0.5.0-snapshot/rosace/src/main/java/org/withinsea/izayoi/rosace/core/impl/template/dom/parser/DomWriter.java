 ...
 * Time: 4:18:05
 */
public class DomWriter extends org.dom4j.io.HTMLWriter {
    ...
    protected void writeElement(Element element) throws IOException {
        ...
        if (!RosaceConstants.TAGNAME_ANONYMOUS.equals(element.getName())) {
    ...
    protected void writeAttributes(Element element) throws IOException {
        for (org.dom4j.Attribute attribute : (List<org.dom4j.Attribute>) element.attributes()) {
            String name = attribute.getName();
            if (!name.equals("xmlns") && !name.startsWith("xmlns:")) {
                if (attribute instanceof DomSurroundableAttr) {
                    DomSurroundableAttr sattr = (DomSurroundableAttr) attribute;
