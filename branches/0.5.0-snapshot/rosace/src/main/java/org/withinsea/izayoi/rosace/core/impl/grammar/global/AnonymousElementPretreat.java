 ...
 * Time: 23:16:41
 */
public class AnonymousElementPretreat implements PretreatGrammar {
    ...
    public String pretreatCode(String code) throws RosaceException {
        return code.replaceAll("<!--</anonymous>-->", "</" + RosaceConstants.TAGNAME_ANONYMOUS + ">")
                .replaceAll("<!--<anonymous([^>]*?)>-->", "<" + RosaceConstants.TAGNAME_ANONYMOUS + "$1>");
    }
}
