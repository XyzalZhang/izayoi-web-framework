 ...
 * Time: 下午4:03
 */
public class HttpServletRequestAttributesMap implements Bindings, Map<String, Object> {

    protected HttpServletRequest owner;

    public HttpServletRequestAttributesMap(HttpServletRequest owner) {
        this.owner = owner;
    }
