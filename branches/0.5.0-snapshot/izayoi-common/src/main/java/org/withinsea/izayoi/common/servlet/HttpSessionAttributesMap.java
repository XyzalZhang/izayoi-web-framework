 ...
 * Time: 下午4:03
 */
public class HttpSessionAttributesMap implements Bindings, Map<String, Object> {

    protected HttpSession owner;

    public HttpSessionAttributesMap(HttpSession owner) {
        this.owner = owner;
    }
