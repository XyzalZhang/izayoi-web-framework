...
public class JSPWriter extends HTMLWriter {
    ...
    public static final String RANGE_TAG_NAME = "__RANGE__";
    ...
    protected void writeElement(Element element) throws IOException {
        ...
        if (!RANGE_TAG_NAME.equals(element.getName())) {
    ...
    protected void writeAttributes(Element element) throws IOException {
        for (Attribute attribute : (List<Attribute>) element.attributes()) {
            ...
            if (!name.equals("xmlns") && !name.startsWith("xmlns:")) {
                if (attribute instanceof HTMLReader.SurroundAttr) {
                    HTMLReader.SurroundAttr sattr = (HTMLReader.SurroundAttr) attribute;
