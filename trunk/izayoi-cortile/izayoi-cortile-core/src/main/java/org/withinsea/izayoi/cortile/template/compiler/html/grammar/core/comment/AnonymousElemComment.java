...
package org.withinsea.izayoi.cortile.template.compiler.html.grammar.core.comment;
...
import org.withinsea.izayoi.cortile.template.compiler.dom.PretreatGrammar;
...
public class AnonymousElemComment implements PretreatGrammar<HTMLCompiler> {
    ...
    public String pretreatCode(HTMLCompiler compiler, Compilr.Result result, String code) throws CortileException {
        return code.replaceAll("<!--</\\s*-->", "</" + DOMCompiler.ANONYMOUS_TAG_NAME + ">")
                .replaceAll("<!--<([^>]*?)-->", "<" + DOMCompiler.ANONYMOUS_TAG_NAME + " $1>");
    }
}
