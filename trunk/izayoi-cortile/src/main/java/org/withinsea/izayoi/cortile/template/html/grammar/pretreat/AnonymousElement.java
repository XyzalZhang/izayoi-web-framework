 ...
 * Time: 23:16:41
 */
public class AnonymousElement implements PretreatGrammar {
    ...
    public String pretreatCode(String code) throws CortileException {
        return code.replaceAll("<!--</anonymous>-->", "</" + HTMLConstants.ANONYMOUS_TAG_NAME + ">")
                .replaceAll("<!--<anonymous([^>]*?)>-->", "<" + HTMLConstants.ANONYMOUS_TAG_NAME + "$1>");
    }
}
