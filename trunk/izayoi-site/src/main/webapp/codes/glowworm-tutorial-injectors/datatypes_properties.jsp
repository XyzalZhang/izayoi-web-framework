...
<%
    Map<String, Object> glowworm = (Map<String, Object>) request.getAttribute("glowworm");
...
<ul>
    <% for (int i = 1; request.getAttribute("types." + i + ".typename") != null; i++) { %>
    <%
        Map<String, Object> type = new HashMap<String, Object>();
        type.put("typename", request.getAttribute("types." + i + ".typename"));
        type.put("extnames", request.getAttribute("types." + i + ".extnames"));
        type.put("deserializer", Boolean.valueOf(request.getAttribute("types." + i + ".deserializer").toString()));
    %>
    <li>
